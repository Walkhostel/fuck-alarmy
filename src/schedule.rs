...
///
///give back epoch-millis (UTC) nearest moment with this time
...
mod tests {
    ...
    fn rolls_over_to_tomorrow_when_time_passed() {
        let now = 20 * 3_600_000i64; // 20:00 UTC,alarm time 07:00->завтра
    ...
    fn respects_timezone_offset() {
        let tz = 3 * 3_600_000i64; //Moscow for example
        let now = 21 * 3_600_000i64; //21:00 UTC=00:00 localy
        let fire = next_fire_time_millis(now, tz, 7, 0); //07:00 localy
